...
public class JdbcUserDao implements UserDao {
    ...
    public User get(String email) {
        ...
        try (Connection connection = dataSource.getConnection();
             PreparedStatement statement = connection.prepareStatement(properties.getProperty("GET_USER_BY_EMAIL_SQL"))) {
    ...
    public User get(int id) {
        ...
        long start = currentTimeMillis();
        try (Connection connection = dataSource.getConnection();
             PreparedStatement statement = connection.prepareStatement(properties.getProperty("GET_USER_BY_ID_SQL"))) {
